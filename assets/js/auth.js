/* ─────────────────────────────────────────────────────────
   ...
   Para cambiar la clave de una semana:
     Abre la consola del navegador y escribe: btoa('TU_CLAVE')
     Copia el resultado y ponlo aquí.
───────────────────────────────────────────────────────── */

var SEMANA_CONFIG = {
  1:  { titulo: 'Intro ML y Árboles',           clave: null,                  disponible: true  },
  2:  { titulo: 'Matemáticas CART',             clave: null,                  disponible: true  },
  3:  { titulo: 'Técnicas de Ensamblado',       clave: null,                  disponible: true  },
...
/* Guardar semana como desbloqueada */
...
/* Proteger una página: si está bloqueada, redirigir */
